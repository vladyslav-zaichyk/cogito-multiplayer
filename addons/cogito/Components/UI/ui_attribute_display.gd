...
@onready
var attribute_label_current: Label = $HBoxContainer/VBoxContainer/HBox_Top/HBoxValues/AttributeLabelCurrent
@onready
var attribute_label_max: Label = $HBoxContainer/VBoxContainer/HBox_Top/HBoxValues/AttributeLabelMax
...
func initiate_interface_ui(_player_attribute: CogitoAttribute):
	...
	CogitoGlobals.debug_log(
		true,
		"CogitoAttributeDisplay",
		"Initiating attribute " + assigned_player_attribute.attribute_display_name
	)
	...
	attribute_bar.init_values(
		assigned_player_attribute.value_current, assigned_player_attribute.value_max
	)

	_player_attribute.attribute_changed.connect(on_attribute_changed)


func on_attribute_changed(
	_attribute_name: String, _value_current: float, _value_max: float, _has_increased: bool
):
