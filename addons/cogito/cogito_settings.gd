...
@export_tool_button("Reset Project Input Map")
var reset_input_map_action = _on_btn_reset_input_map_pressed
...
func save_input_action_to_settings(
	input_name: String, input_kbm: InputEventWithModifiers, input_gamepad: InputEvent
):
	var input = {"deadzone": 0.5, "events": [input_kbm, input_gamepad]}
	...
	print(
		"COGITO: Saved input to settings: ",
		setting_name,
		". input_kbm=",
		input_kbm,
		". input_gamepad=",
