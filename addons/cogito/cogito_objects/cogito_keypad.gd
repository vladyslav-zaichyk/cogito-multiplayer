...
@onready
var code_display: Label = $KeypadUi/Bindings/ScrollContainer/VBoxContainer/HBoxContainer/Panel/CodeDisplay
@onready
var grab_focus_button: Control = $"KeypadUi/Bindings/ScrollContainer/VBoxContainer/GridContainer/5"
@onready
var lock_color: Panel = $KeypadUi/Bindings/ScrollContainer/VBoxContainer/HBoxContainer/LockColor
