...
@onready
var wieldable_charge_label: Label = $MarginContainer/VBoxContainer/WieldableData/WieldableChargeLabel
...
func update_wieldable_data(
	wieldable_item: WieldableItemPD, _carried_ammo: int, _ammo_item: AmmoItemPD
):
