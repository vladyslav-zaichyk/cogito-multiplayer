...
var languages: Array[Dictionary] = [
	{
		"code": "en",
		"icon": preload("res://addons/cogito/Assets/Graphics/Flags/freepik_flag_us.png"),
		"text": "  English"
	},
	{
		"code": "de",
		"icon": preload("res://addons/cogito/Assets/Graphics/Flags/freepik_flag_de.png"),
		"text": "  Deutsch"
	},
]
...
func apply_language(language: Dictionary) -> void:
	...
	print(
		...
		"(",
		language_code,
		") and saved to user://language.cfg"
	)
