...
const AvailableQuests = preload("./quest_groups/available_quests_group.gd")
const ActiveQuests = preload("./quest_groups/active_quests_group.gd")
const CompletedQuests = preload("./quest_groups/completed_quests_group.gd")
const FailedQuests = preload("./quest_groups/failed_quests_group.gd")
