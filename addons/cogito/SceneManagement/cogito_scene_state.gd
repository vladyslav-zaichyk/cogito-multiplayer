...
var scene_state_dir: String = (
	CogitoSceneManager.cogito_state_dir + CogitoSceneManager.cogito_scene_state_prefix
)
...
func write_state(state_slot: String, scene_name: String) -> void:
	...
	var scene_state_file = str(
		(
			CogitoSceneManager.cogito_state_dir
			+ state_slot
			+ "/"
			+ CogitoSceneManager.cogito_scene_state_prefix
			+ scene_name
			+ ".res"
		)
	)
	...
	CogitoGlobals.debug_log(
		true, "cogito_scene_state.gd", "Scene state saved as " + scene_state_file
	)
...
func state_exists(state_slot: String, scene_name: String) -> bool:
	...
	CogitoGlobals.debug_log(
		true, "cogito_scene_state.gd", "Looking if stat exists: " + scene_state_file
	)
