...
func update_quickslot_data(slot_data: InventorySlotPD) -> void:
	if slot_data == null:
		CogitoGlobals.debug_log(
			true, "COgitoQuickslotContainer", "update_quickslot_data(): passed slot_data was null!"
		)
		inventory_slot_reference = null
		item_reference = null
		item_texture.hide()
		...
		CogitoGlobals.debug_log(
			true,
			"COgitoQuickslotContainer",
			"update_quickslot_data(): passed slot_data was " + str(slot_data)
		)
